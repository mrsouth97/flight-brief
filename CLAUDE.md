...
- Chart là Lido trong app mLido (không có PDF) → minima **nhập tay** (nút "Approach minima"), lưu IndexedDB `flight-brief-minima`. Form V5.96 chỉ 4 ô: ICAO · Approach (gõ tự do kèm runway, vd "ILS CAT2 11L", "VOR 11L", "CIRCLING") · DH/MDH · Minima (m, hoặc km nếu < 20, vd 2.4). App tự nhận runway và loại: CIRCL → Circling; CAT3 → CAT III; CAT2 → CAT II; ILS/GLS → CAT I; còn lại (RNP/RNAV nhập cột LNAV, LOC, VOR, NDB) → NPA. Hàng CAT C.
