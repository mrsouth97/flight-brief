...
- Khung **Loadsheet** đầu tab DGR (V6.16): đọc loadsheet mới nhất (R cao nhất) của chuyến → NOTOC YES/NO + bảng Position → mã IMP (bảng `IMP_CODES` theo DGM 3.2.2.1 b / DGR App. B 2.2.4); cảnh báo đỏ nếu 2 mã cùng vị trí phải cách ly (9.3.A), ICE ngoài BULK (5), MAG ngoài compartment 3/4.
