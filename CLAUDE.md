...
- Bản web (Safari iPhone, V6.14): nút **Import DGR data** → chọn `dgr.json` trong Google Drive › Tài Liệu › DGR (bản sao do Claude chép vào Drive) → lưu IndexedDB `flight-brief-dgr` trên máy đó. Khi cập nhật dgr.json nhớ chép lại lên Drive.
