...
## DGR (V6.04)
- Tab **DGR** trong màn hình chuyến bay: gõ UN/ID number → hiện dòng Blue Pages (class, labels, PG, EQ, Ltd Qty, PAX, CAO, SP, ERG + nghĩa theo ICAO Doc 9481), trạng thái FORBIDDEN / NOT ACCEPTED ON VNA / CAO ONLY / NO VNA RESTRICTION, và kiểm tra giới hạn VNA theo DGM 2.5.8 a) (ưu tiên hơn DGR 2.8 VN-xx) + VN-11. Người dùng chọn phạm vi "chỉ tra UN", không làm checklist NOTOC đầy đủ.
